...
parser.add_argument('--img', type=str, default='images/cat.png', help='path to image')
parser.add_argument('--d', type=int, default=1, help='number of pixels to change')
...
# print(model.load_state_dict(saved['state_dict']))
model.eval()
